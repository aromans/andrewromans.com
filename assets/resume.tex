...
\begin{cventries}
  %---------------------------------------------------------
  \cventry
    {Vulnerability Researcher & Security Engineer} % Job title
    {Viasat} % Organization
    {Carlsbad, CA} % Location
    {Jan. 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Conduct in-depth malware analysis and reverse engineering of sophisticated threats, dissecting binaries to identify exploitation techniques, command-and-control mechanisms, and indicators of compromise.}
        \item {Perform vulnerability research and penetration testing across network infrastructure, embedded systems, and applications.}
        \item {Leverage low-level debugging, disassembly (IDA Pro/Ghidra/BinaryNinja), and dynamic analysis tools to reverse engineer malicious code or for vulnerability research.}
        \item {For more information or inquiries, please reach out via email.}
      \end{cvitems}
    }
