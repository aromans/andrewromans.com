...
\begin{cventries}
  %---------------------------------------------------------
  \cventry
    {Vulnerability Researcher and Security Engineer} % Job title
    {Viasat} % Organization
    {Carlsbad, CA} % Location
    {Jan. 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Conduct in-depth malware analysis and reverse engineering of sophisticated threats.}
        ...
        \item {Leverage low-level debugging, disassembly (IDA Pro/Ghidra/BinaryNinja), and dynamic analysis tools (AFL++/Unicorn/Angr) for vulnerability research or malware analysis.}
